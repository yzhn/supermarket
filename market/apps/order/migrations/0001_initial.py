# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-02-14 12:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mod_time', models.DateTimeField(auto_now=True)),
                ('is_delete', models.BooleanField(default=False, verbose_name='是否删除')),
                ('goods_sku', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.ShopSKU', verbose_name='订单商品ID')),
        ...
        migrations.AddField(
            model_name='order',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.Register', verbose_name='用户'),
        ),
    ]
